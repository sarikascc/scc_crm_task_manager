          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#1E1B4B]">Client Name</th>
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#1E1B4B]">Company</th>
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#1E1B4B]">Phone</th>
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#1E1B4B]">Status</th>
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#1E1B4B]">Created</th>
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {[...Array(20)].map((_, i) => (
                <tr key={i} className="animate-pulse">
                  ...
                  <td className="whitespace-nowrap px-4 sm:px-6 py-4"><div className="h-4 w-28 rounded bg-gray-200" /></td>
